...
//		11. Suppose a source file contains a large number of import statements. How do the imports affect 
//		the time required to compile the source file?
...
//		14. Which of the following may be statiAlerty imported? (Choose all that apply.)
//		A. Package names
//		B. Static method names
//		C. Static field names
//		D. Method-local variable names
//		# 14. B, C. You may statiAlerty import method and field names
	}
}