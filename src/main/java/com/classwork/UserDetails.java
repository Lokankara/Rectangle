...
public final class UserDetails implements Serializable {
	...
	public UserDetails(String aFirstName, String aLastName, int aAccountNumber, Date aDateOpened) {
		super();
...
// The default constructor
	...
	/**
	 * Returns a defensive copy of the field so that no one can change this field.
	 */
	...
	/**
	 * Determines if a de-serialized file is compatible with this class. Included
	...
	/**
	 * Always treat deserialization as a full-blown constructor, by validating the
