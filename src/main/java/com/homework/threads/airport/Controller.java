...
import static main.java.com.homework.threads.airport.Main.AMOUNT;
import static main.java.com.homework.threads.airport.Main.PLANES;


public class Controller {
    static List<Family> passengers = new ArrayList<>();
    protected static List<Plane> aircraft = new ArrayList<>();
    protected static final List<Bus> buses = new ArrayList<>();
...
//
        ...
        Terminal terminal = new Terminal(aircraft);
//        Station station = new Station(towns, aircraft.size());
...
//        Station.getBuses().forEach(Transport::join);
    ...
    public static void executeMultiMode() {
...
//        station.thread.start();
    ...
    protected static Bus getBus(String city, int seats, List<Family> families) {
        return new Bus(city, families, seats);
    }
    ...
    protected static Family getFamily(int plane) {
        return new Family(generateMemberFamily(), Controller.generateName(97, 122, 5), plane, Controller.generateCity());
    }
}
